...
class CourseRegistrationsControllerTest < ActionController::TestCase
  ...
  test "should create course_registration" do
    assert_difference('CourseRegistration.count') do
      post :create, course_registration: { contact: @course_registration.contact, course_id: @course_registration.course_id, email: @course_registration.email, first_name: @course_registration.first_name, last_name: @course_registration.last_name }
    end
  ...
  test "should update course_registration" do
    patch :update, id: @course_registration, course_registration: { contact: @course_registration.contact, course_id: @course_registration.course_id, email: @course_registration.email, first_name: @course_registration.first_name, last_name: @course_registration.last_name }
    assert_redirected_to course_registration_path(assigns(:course_registration))
  end
